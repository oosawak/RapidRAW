 ...
 * @returns {Uint8Array}
 */
export function grade_rgba(input, width, height, exposure, contrast, saturation, temperature, shadows, vignette, grain) {
    const ptr0 = passArray8ToWasm0(input, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.grade_rgba(ptr0, len0, width, height, exposure, contrast, saturation, temperature, shadows, vignette, grain);
 ...
 * @returns {Float32Array}
 */
export function interpolate_stroke(points, spacing) {
    const ptr0 = passArrayF32ToWasm0(points, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.interpolate_stroke(ptr0, len0, spacing);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rapidraw_wasm_bg.wasm?rev=b1f3a9c2', import.meta.url);
    }
    const imports = __wbg_get_imports();
